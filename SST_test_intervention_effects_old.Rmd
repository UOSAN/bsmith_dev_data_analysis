...
### Directional test
First of all, is the prediction _directionally_ right, i.e., does RT to healthy food decrease, unhealthy increase, and Unhealth-Healthy increase even more?

```{r}
healthy_vs_unhealthy %>% filter(condition=="CorrectGo")
```
...
summary(lm(healthy_minus_unhealthy_rt_w2_m_w1~1,results_by_subj_brt_test %>% filter(condition=="CorrectGo")))
summary(lm(healthy_minus_unhealthy_rt_w2_m_w1~intervention_group,results_by_subj_brt_test %>% filter(condition=="CorrectGo")))

summary(lm(healthy_minus_unhealthy_rt_w3_m_w1~1,results_by_subj_brt_test %>% filter(condition=="CorrectGo")))
summary(lm(healthy_minus_unhealthy_rt_w3_m_w1~intervention_group,results_by_subj_brt_test %>% filter(condition=="CorrectGo")))

summary(lm(healthy_minus_unhealthy_rt_w4_m_w1~1,results_by_subj_brt_test %>% filter(condition=="CorrectGo")))
summary(lm(healthy_minus_unhealthy_rt_w4_m_w1~intervention_group,results_by_subj_brt_test %>% filter(condition=="CorrectGo")))
```
