...
```{r}
roc_events_raw <- readr::read_csv("/Users/benjaminsmith/Google Drive/oregon/preprocessing/DEV_scripts/fMRI/fx/multiconds/ROC/betaseries/events.csv")
```
...
```{r}
readr::write_csv(roc_events_raw,file = paste0(data_path,"roc_behavioral_data_all.csv"))
```
...
```{r}
readr::write_csv(mean_ratings,file=paste0(data_path,"roc_summary_stats.csv"))
```
