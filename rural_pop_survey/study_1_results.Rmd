...
```{r}
#save.image(file=paste0(config::get("rural_data_dir"),"study_1_2_output.Rdata"))
```

```{r}
load(file=paste0(config::get("rural_data_dir"),"study_1_2_output.Rdata"))
```
