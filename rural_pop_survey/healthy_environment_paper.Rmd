...
predict_bmi <- lm(BMI~
                    ...
                    DEMO_Age_c+Gender3C+RaceCategorical,
                  orfcs_dataset)
summary(predict_bmi)
...
mb <- lm(cancer_promoting_minus_preventing_FFQ~MESA_healthyfoodavailability+Gender3C+DEMO_Age_c+RaceCategorical2,data_to_measure)
mc <- lm(BMI~MESA_healthyfoodavailability+Gender3C+DEMO_Age_c+RaceCategorical2+cancer_promoting_minus_preventing_FFQ,data_to_measure)
