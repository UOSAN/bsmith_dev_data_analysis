...
Get a count of exactly what hte missing data is
```{r}
orfcs_zip_not_na <- orfcs_dataset_pp[!is.na(orfcs_dataset_pp$RuralZIP)]
table(data.frame(!is.na(orfcs_zip_not_na[,c(
  "aSES_02_z",
  "BMI",
  "DEMO_Age_c")])))
```
...
```{r}
#save.image(file=paste0("sequential_boot_",boot_times,".Rdata"))
load(file=paste0("sequential_boot_",boot_times,".Rdata"))
```
