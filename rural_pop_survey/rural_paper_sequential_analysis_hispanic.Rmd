...
hints_model <- lm(
  MedConditions_HighBP_i~Fruit_vegetables_z+HINTSIsRural_i+Age_c+I(Age_c^2)+RacePP+Hisp_Cat2+Gender3C+filename
  ,hints5_pp)
summary(hints_model)
...
```{r}
hints_hbp<-lm(
  MedConditions_HighBP_i~Fruit_vegetables_z+HINTSIsRural_i+Age_c+Age_c_pow2+RacePP+Hisp_Cat2+Gender3C+filename
  ,hints5_pp)
summary(hints_hbp)
confint(hints_hbp)
```
