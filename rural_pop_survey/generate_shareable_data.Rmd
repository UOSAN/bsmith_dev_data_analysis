...
ds_shareable_columns <- orfcs_dataset %>% select(colnames(orfcs_dataset)[cols_to_select])
...
ds_shareable_columns$aSES_02_z<-NULL
ds_shareable_columns$BMI <-round(ds_shareable_columns$BMI)
